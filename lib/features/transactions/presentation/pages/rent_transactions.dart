...
class RentTransactions extends StatefulWidget {
  const RentTransactions({super.key});

  @override
  State<RentTransactions> createState() => _RentTransactionsState();
}

class _RentTransactionsState extends State<RentTransactions> {
  String startDate = '';
  String endDate = '';
  @override
  void initState() {
